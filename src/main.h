...
static const uint256 hashGenesisBlock("00000141950ae3eb8f62e43fb0eb5a1bbe74a11dd6f11af91506837c32961f5f");
...
public:
    ...
    {
        // Pesa: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // Pesa: get transaction coin age
...
public:
    ...
    // Pesa: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Pesa: two types of block: proof-of-work or proof-of-stake
    ...
    // Pesa: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // Pesa: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Pesa: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Pesa: block index flags
    enum  
    {
